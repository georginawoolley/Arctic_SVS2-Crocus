...
Default_Mar2018 = ncread('Density_SSA_Profiles.nc','Denisty_Default_Mar2018'); % March 2018;
Default_Nov2018 = ncread('Density_SSA_Profiles.nc','Denisty_Default_Nov2018'); % November 2018; 
Default_Jan2019 = ncread('Density_SSA_Profiles.nc','Denisty_Default_Jan2019'); % January 2019; 
Default_Mar2019 = ncread('Density_SSA_Profiles.nc','Denisty_Default_Mar2019'); % March 2019;
Default_Mar2022 = ncread('Density_SSA_Profiles.nc','Denisty_Default_Mar2022'); % March 2022; 
Default_Mar2023 = ncread('Density_SSA_Profiles.nc','Denisty_Default_Mar2023'); % March 2023;

%% Load in Arctic Ensemble Data;

Arctic_Mar2018 = ncread('Density_SSA_Profiles.nc','Denisty_Arctic_Mar2018'); % March 2018;
Arctic_Nov2018 = ncread('Density_SSA_Profiles.nc','Denisty_Arctic_Nov2018'); % November 2018; 
Arctic_Jan2019 = ncread('Density_SSA_Profiles.nc','Denisty_Arctic_Jan2019'); % January 2019; 
Arctic_Mar2019 = ncread('Density_SSA_Profiles.nc','Denisty_Arctic_Mar2019'); % March 2019;
Arctic_Mar2022 = ncread('Density_SSA_Profiles.nc','Denisty_Arctic_Mar2022'); % March 2022; 
Arctic_Mar2023 = ncread('Density_SSA_Profiles.nc','Denisty_Arctic_Mar2023'); % March 2023;

%% Load in Mixed Ensemble Data;

Mixed_Mar2018 = ncread('Density_SSA_Profiles.nc','Denisty_Mixed_Mar2018'); % March 2018;
Mixed_Nov2018 = ncread('Density_SSA_Profiles.nc','Denisty_Mixed_Nov2018'); % November 2018; 
Mixed_Jan2019 = ncread('Density_SSA_Profiles.nc','Denisty_Mixed_Jan2019'); % January 2019; 
Mixed_Mar2019 = ncread('Density_SSA_Profiles.nc','Denisty_Mixed_Mar2019'); % March 2019;
Mixed_Mar2022 = ncread('Density_SSA_Profiles.nc','Denisty_Mixed_Mar2022'); % March 2022; 
Mixed_Mar2023 = ncread('Density_SSA_Profiles.nc','Denisty_Mixed_Mar2023'); % March 2023;
...
%% FIGURE 4: March Density Profiles; 
figure(1);
t=tiledlayout(2,4);
...
nexttile
stairs(a_Final_Pit_Mar2018(:,:),b_Final_Pit_Mar2018(:,:),'k','LineWidth',1);
...
nexttile
stairs(a_Final_Pit_Mar2019(:,:),b_Final_Pit_Mar2019(:,:),'k','LineWidth',1);
ylabel('Normalized Depth');
xlim([0 500]);
xticks([0 100 200 300 400 500]);
xticklabels({'0','100','200','300','400','500'});
...
nexttile
stairs(a_Final_Pit_March2022(:,:),b_Final_Pit_March2022(:,:),'k','LineWidth',1);
ylabel('Normalized Depth');
xlim([0 500]);
xticks([0 100 200 300 400 500]);
xticklabels({'0','100','200','300','400','500'});
...
nexttile
stairs(a_Final_Pit_March2023(:,:),b_Final_Pit_March2023(:,:),'k','LineWidth',1);
ylabel('Normalized Depth');
xlim([0 500]);
xticks([0 100 200 300 400 500]);
xticklabels({'0','100','200','300','400','500'});
...
%% FIGURE 6: Temporal Density Profiles; 
figure(2);
t=tiledlayout(2,3);
t.TileSpacing='compact';
t.Padding='compact';
...
nexttile
stairs(a_Final_Pit_Nov2018(:,:),b_Final_Pit_Nov2018(:,:),'k','LineWidth',1);
ylabel('Normalized Depth');
xlim([0 500]);
ylim([0 1]);
xticks([0 100 200 300 400 500]);
...
nexttile
stairs(a_Final_Pit_Jan2019(:,:),b_Final_Pit_Jan2019(:,:),'k','LineWidth',1);
ylabel('Normalized Depth');
xlim([0 500]);
xticks([0 100 200 300 400 500]);
xticklabels({'0','100','200','300','400','500'});
