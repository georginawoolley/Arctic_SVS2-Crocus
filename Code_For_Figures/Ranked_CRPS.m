% Load in data;
% Ensemble Members;
filenames_Default = ncread('Ensemble_CRPS.nc','filenames_Default');
filenames_Arctic = ncread('Ensemble_CRPS.nc','filenames_Arctic');
filenames_Mixed = ncread('Ensemble_CRPS.nc','filenames_Mixed');

% Default Ensemble;
mean_CRPS_Default_Mar2018 = ncread('Ensemble_CRPS.nc','mean_CRPS_Default_Mar2018');
mean_CRPS_Default_Mar2019 = ncread('Ensemble_CRPS.nc','mean_CRPS_Default_Mar2019');
mean_CRPS_Default_Mar2022 = ncread('Ensemble_CRPS.nc','mean_CRPS_Default_Mar2022');
mean_CRPS_Default_Mar2023 = ncread('Ensemble_CRPS.nc','mean_CRPS_Default_Mar2023');

% Arctic Ensemble;
mean_CRPS_Arctic_Mar2018 = ncread('Ensemble_CRPS.nc','mean_CRPS_Arctic_Mar2018');
mean_CRPS_Arctic_Mar2019 = ncread('Ensemble_CRPS.nc','mean_CRPS_Arctic_Mar2019');
mean_CRPS_Arctic_Mar2022 = ncread('Ensemble_CRPS.nc','mean_CRPS_Arctic_Mar2022');
mean_CRPS_Arctic_Mar2023 = ncread('Ensemble_CRPS.nc','mean_CRPS_Arctic_Mar2023');

% Mixed Ensemble;
mean_CRPS_Mixed_Mar2018 = ncread('Ensemble_CRPS.nc','mean_CRPS_Mixed_Mar2018');
mean_CRPS_Mixed_Mar2019 = ncread('Ensemble_CRPS.nc','mean_CRPS_Mixed_Mar2019');
mean_CRPS_Mixed_Mar2022 = ncread('Ensemble_CRPS.nc','mean_CRPS_Mixed_Mar2022');
mean_CRPS_Mixed_Mar2023 = ncread('Ensemble_CRPS.nc','mean_CRPS_Mixed_Mar2023');
