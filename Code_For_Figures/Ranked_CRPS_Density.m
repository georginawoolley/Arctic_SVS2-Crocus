...
% Default Ensemble;
mean_CRPS_Default_Mar2018 = ncread('Ensemble_CRPS.nc','CRPS_Def_Mar2018_Density');
mean_CRPS_Default_Mar2019 = ncread('Ensemble_CRPS.nc','CRPS_Def_Mar2019_Density');
mean_CRPS_Default_Mar2022 = ncread('Ensemble_CRPS.nc','CRPS_Def_Mar2022_Density');
mean_CRPS_Default_Mar2023 = ncread('Ensemble_CRPS.nc','CRPS_Def_Mar2023_Density');

% Arctic Ensemble;
mean_CRPS_Arctic_Mar2018 = ncread('Ensemble_CRPS.nc','CRPS_Arc_Mar2018_Density');
mean_CRPS_Arctic_Mar2019 = ncread('Ensemble_CRPS.nc','CRPS_Arc_Mar2019_Density');
mean_CRPS_Arctic_Mar2022 = ncread('Ensemble_CRPS.nc','CRPS_Arc_Mar2022_Density');
mean_CRPS_Arctic_Mar2023 = ncread('Ensemble_CRPS.nc','CRPS_Arc_Mar2023_Density');

% Mixed Ensemble;
mean_CRPS_Mixed_Mar2018 = ncread('Ensemble_CRPS.nc','CRPS_Mixed_Mar2018_Density');
mean_CRPS_Mixed_Mar2019 = ncread('Ensemble_CRPS.nc','CRPS_Mixed_Mar2019_Density');
mean_CRPS_Mixed_Mar2022 = ncread('Ensemble_CRPS.nc','CRPS_Mixed_Mar2022_Density');
mean_CRPS_Mixed_Mar2023 = ncread('Ensemble_CRPS.nc','CRPS_Mixed_Mar2023_Density');
